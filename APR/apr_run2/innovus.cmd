...
#  Created on Wed Nov 26 23:30:31 2025                
#                                                     
#######################################################
...
set init_verilog {apr45nm.v synth_netlist.v}
set init_pwr_net 1'b1
init_design
getIoFlowFlag
setFPlanRowSpacingAndType 4.0 1
setIoFlowFlag 0
floorPlan -flip n -site CoreSite -r 1 0.5 7.0 7 7 7
uiSetTool select
getIoFlowFlag
fit
...
setPlaceMode -reset
setPlaceMode -congEffort low -timingDriven 0 -modulePlan 1 -clkGateAware 0 -powerDriven 0 -ignoreScan 1 -reorderScan 1 -ignoreSpare 1 -placeIOPins 1 -moduleAwareSpare 0 -checkPinLayerForAccess {  1 } -preserveRouting 0 -rmAffectedRouting 0 -checkRoute 0 -swapEEQ 0
...
timeDesign -postRoute -pathReports -drvReports -expandedViews -prefix postRoute
